...
public class TreeNode<T> {
    ...
    /**
     * Exchanges current parent with the new parent, removing this node from the children list of the old parent and
     * adding it to the children list of the new parent
     *
     * @param newParent New parent
     */
    public void changeParent(TreeNode<T> newParent) {
        this.parent.children.remove(this);
        List<TreeNode<T>> children = new ArrayList<>(newParent.children);
        children.add(this);
